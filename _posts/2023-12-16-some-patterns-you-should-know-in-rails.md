---
layout: post
title: Some Patterns You Should Know in Ruby on Rails
category: Rails
tag: DesignPattern
excerpt_separator: <!--more-->
---
Khi làm việc với Ruby on Rails, có nhiều trường hợp ta không biết nên viết code ở đâu để có thể tái sử dụng hay để dễ dàng maintain sau này. Dưới đây là một số design patterns mà bạn nên biết.
<!--more-->

![image](https://github.com/dongoclam/dongoclam.github.io/assets/35123339/17893e9f-5ff6-4fea-b506-66f24ec5b827)
...
Vừa rồi là một số pattern thường được sử dụng trong Ruby on Rails, ở những framework khác chúng sẽ có các biến thể hoặc cách gọi tên khác nhưng mục đích của chúng không thay đổi.
